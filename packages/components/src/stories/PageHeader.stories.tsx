...
const breadcrumbs = <ol style={{display: 'flex', gap: 'var(--fds-space-8)', margin: 0, padding: 0, listStyle: 'none'}}><li><a href="#operations">Operations</a></li><li aria-hidden="true">/</li><li aria-current="page">Shipment review</li></ol>;
