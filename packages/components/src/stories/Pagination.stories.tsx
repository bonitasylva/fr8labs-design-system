...
export const BoundaryPages: Story = {
  render: () => <div style={{display: 'grid', gap: 'var(--fds-space-24)'}}><Pagination page={1} pageCount={6} onPageChange={() => {}} label="First-page boundary" /><Pagination page={6} pageCount={6} onPageChange={() => {}} label="Last-page boundary" /></div>,
};
